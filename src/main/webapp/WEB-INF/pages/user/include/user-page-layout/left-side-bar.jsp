    ...
    <section class="sidebar">
      ...
      <span class="pull-left# image profile" >
      	<img data-ng-src="{{userInfoByUserID.PROFILE}}" class="img-circle" alt="User Image">
            ...
            <br><br>
            <div class="user-info text-upper" style="text-align: center; ">
                <span style="font-size:20px;text-transform: uppercase;">${userName}</span>  <br>
                <span style="font-size:15px">${userEmail}</span>
