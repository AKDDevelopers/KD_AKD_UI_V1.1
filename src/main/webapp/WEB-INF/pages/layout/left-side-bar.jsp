...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview" ng-repeat="sub1 in parentCategory" ng-init="sub1.ICON='fa fa-th-large'" ng-click="getAllDocumentByCatID(sub1.CAT_ID);getTotalDocByCatID(sub1.TOTAL_DOC)">   
           <a href="#" >
